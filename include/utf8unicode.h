...
class Utf8Unicode {
public:
    static bool utf8_to_unicode(const String &utf8, std::vector<unsigned int> &unicode) {
        ...
        while (utf8_cursor < utf8length) {
            p = (unsigned char*)&utf8.c_str()[utf8_cursor];
            if (*p < 0xC0) {
                offset = 0;
                e = p[0];
            }
    ...
    static void unicode_to_utf8(const std::vector<unsigned int> &unicode, String &utf8) {
